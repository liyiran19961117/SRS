...
public class SRS {
	...
	public static void main(String[] args) {
		...
		s1 = new Student("Joe Blow", "111-11-1111","123456", "Math", "M.S.");

		s2 = new Student("Fred Schnurd", "222-22-2222","123456", 
				 "Information Technology", "Ph. D.");

		s3 = new Student("Mary Smith", "333-33-3333","123456", "Physics", "B.S.");
