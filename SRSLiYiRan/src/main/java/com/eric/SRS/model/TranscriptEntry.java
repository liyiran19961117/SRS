...
@Entity
@Table(name = "transcriptEntry")
public class TranscriptEntry {
	// ------------
	// Attributes.
	// ------------
	@Id
	@Column(name = "transcriptEntry_id")
	private int transcriptEntryId;
	...
	@JoinColumn(name = "transcript_id", referencedColumnName = "transcript_id", nullable = false)
	...
	public int getTranscriptEntryId() {
		return transcriptEntryId;
	}

	public void setTranscriptEntryId(int transcriptEntryId) {
		this.transcriptEntryId = transcriptEntryId;
	}
