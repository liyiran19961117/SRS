...
public class Student extends Person implements java.io.Serializable{
	...
	@ManyToMany(targetEntity = Section.class, cascade = CascadeType.ALL)
	@JoinTable(name = "student_section", joinColumns = @JoinColumn(name = "person_id", referencedColumnName = "person_id"), inverseJoinColumns = @JoinColumn(name = "section_id", referencedColumnName = "section_id"))
	private List<Section> attends=new ArrayList<Section>();
