  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          <a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> Library MIS System</span></a></div>
    ...
    <div class="panel panel-default">
        <p class="panel-heading no-collapse">注册新用户</p>
