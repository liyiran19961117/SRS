	...
	<ul>
		...
		<li>
			<ul class="dashboard-menu nav nav-list collapse in">
				...
				<li><a href="adminUsers.jsp"><span
						class="fa fa-caret-right"></span> 课程查询选课</a></li>
				<li><a
					href=" "><span
						class="fa fa-caret-right"></span> 学生成绩查询</a></li>
			</ul>
		</li>
		...
		<li>
			<ul class="premium-menu nav nav-list collapse">
				...
				<li><a href="booking.jsp"><span class="fa fa-caret-right"></span>
						其他功能</a></li>
				<li><a href="place.jsp"><span class="fa fa-caret-right"></span>其他功能</a></li>
